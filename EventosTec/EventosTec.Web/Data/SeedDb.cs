...
namespace EventosTec.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("Adamari", "Mosqueda", "adamari.mosqueda16@tectijuana.edu.mx", "664 123 45 67",
                 "Admin");
            var customer = await CheckUserAsync("Crow", "Armbrust", "azurechevalier@gmail.com", "664 666 44 44",
                 "Client");
